...
import Excel.excelone;

public class loginone extends excelone {
	...
	public loginone(WebDriver driver) {
		this.driver = driver;
...
//login button		
	...
	public void loginexcel_test() throws Exception {
		datadriven("Sheet1");
		String Mail_textbox = sheet.getRow(1).getCell(0).getStringCellValue();
		String password_textbox = sheet.getRow(1).getCell(1).getStringCellValue();
